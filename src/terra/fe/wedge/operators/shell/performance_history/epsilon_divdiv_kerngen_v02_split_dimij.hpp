...
class EpsilonDivDivKerngenV02SplitDimij
{
  public:
  ...
  public:
    EpsilonDivDivKerngenV02SplitDimij(
...
static_assert( linalg::OperatorLike< EpsilonDivDivKerngenV02SplitDimij< float > > );
static_assert( linalg::OperatorLike< EpsilonDivDivKerngenV02SplitDimij< double > > );
