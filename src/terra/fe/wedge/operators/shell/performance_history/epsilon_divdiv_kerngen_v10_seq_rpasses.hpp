...
class EpsilonDivDivKerngenV10SeqRpasses
{
  public:
  ...
  public:
    EpsilonDivDivKerngenV10SeqRpasses(
...
static_assert( linalg::GCACapable< EpsilonDivDivKerngenV10SeqRpasses< float > > );
static_assert( linalg::GCACapable< EpsilonDivDivKerngenV10SeqRpasses< double > > );
